    ...
    <div class="hero-inner">
      ...
      <div class="hero-visual reveal reveal-delay-2">
        ...
        <div class="hv-composition">
          <div class="hv-photo-col"><div class="hv-photo-frame"><img src="<?php em_theme_url(); ?>/pages/order-processing/images/hero-person.webp" alt="Store owner with automated order processing" class="hv-photo"><div class="hv-photo-glow"></div></div></div>
          <div class="hv-dash-col"><div class="hv-dash"><div class="hv-dash-shimmer"></div>
            <div class="hv-dash-header"><span class="hv-dash-logo">ecomzy<span>.</span></span><span class="hv-dash-status"><span class="hv-status-dot"></span> Orders</span></div>
            <div class="hv-dash-stats"><div class="hv-stat"><div class="hv-stat-label">Processed</div><div class="hv-stat-value">847</div><div class="hv-stat-change">Auto</div></div><div class="hv-stat"><div class="hv-stat-label">Delivery</div><div class="hv-stat-value">1s</div><div class="hv-stat-change">Instant</div></div></div>
            <div class="hv-dash-chart"><svg viewBox="0 0 200 50" preserveAspectRatio="none" class="hv-chart-svg"><defs><linearGradient id="hvc" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stop-color="rgba(20,184,166,.2)"/><stop offset="100%" stop-color="rgba(20,184,166,0)"/></linearGradient></defs><path d="M0,38 Q30,34 60,28 T120,18 T160,10 T200,6 V50 H0Z" fill="url(#hvc)"/><path d="M0,38 Q30,34 60,28 T120,18 T160,10 T200,6" fill="none" stroke="#14B8A6" stroke-width="2"/><circle cx="200" cy="6" r="3" fill="#14B8A6"/></svg></div>
            <div class="hv-dash-orders"><div class="hv-order"><span class="hv-order-dot paid"></span><span class="hv-order-name">Order #4821 delivered</span><span class="hv-order-amount">Auto</span></div><div class="hv-order"><span class="hv-order-dot paid"></span><span class="hv-order-name">Order #4820 delivered</span><span class="hv-order-amount">Auto</span></div><div class="hv-order"><span class="hv-order-dot paid"></span><span class="hv-order-name">Order #4819 delivered</span><span class="hv-order-amount">Done</span></div></div>
          </div></div>
        </div>
  ...
  <div class="container">
    <div class="benefits-grid">
      ...
      <div class="benefit-card reveal rd2">
        ...
        <p>Customers get their products instantly, keeping satisfaction high and support tickets low.</p>
      </div>
  ...
  <div class="container">
    ...
    <div class="features-track">
      <div class="feature-card reveal">
        <div class="feature-img"><img src="<?php em_theme_url(); ?>/pages/order-processing/images/benefit-1.webp" alt="" loading="lazy"></div>
        <div class="feature-content"><h3>Auto-process every order</h3><p>The moment a sale happens, fulfillment begins immediately without you lifting a finger.</p></div>
      </div>
      <div class="feature-card reveal rd1">
        <div class="feature-img"><img src="<?php em_theme_url(); ?>/pages/order-processing/images/benefit-2.webp" alt="" loading="lazy"></div>
        <div class="feature-content"><h3>One-click credit top-up</h3><p>Keep your balance full with a simple payment, then enjoy weeks of hands-free processing.</p></div>
      </div>
    ...
    <div class="features-controls">
      <button class="slider-btn slider-prev" aria-label="Previous"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><path d="M15 18l-6-6 6-6"/></svg></button>
      <div class="slider-dots"></div>
      <button class="slider-btn slider-next" aria-label="Next"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 18l6-6-6-6"/></svg></button>
    </div>
    </div>
  </div>
</section>
...
<section class="lp-cta">
  <div class="container">
    <div class="lp-cta-box reveal">
      ...
      <h2 class="section-title">Activate autopilot <em>order processing</em></h2>
      <p class="section-sub">Get your free store and make fulfillment completely hassle-free from day one.</p>
      <a href="<?php echo em_start_for_free_url(); ?>" class="btn-primary liquid-btn">Start Your Free Store <svg width="18" height="18" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round"><path d="M4 9h10M10 5l4 4-4 4"/></svg></a>
