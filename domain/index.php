...
<section class="features-section">
  <div class="container">
    <div class="features-header reveal">
      ...
      <h2 class="section-title">A seamless domain experience <em>from choice to launch</em></h2>
      <p class="section-sub">We don&rsquo;t just help you pick a domain &ndash; we handle the entire technical setup and transfer your store so you can focus on selling.</p>
    </div>
    <div class="features-slider">
    <div class="features-track">
      <div class="feature-card reveal">
        <div class="feature-img"><img src="<?php em_theme_url(); ?>/pages/domain/images/benefit-1.webp" alt="" loading="lazy"></div>
        <div class="feature-content"><h3>Choose your perfect domain</h3><p>Browse and select a great domain that fits your brand, with guidance available if you need help.</p></div>
      </div>
      <div class="feature-card reveal rd1">
        <div class="feature-img"><img src="<?php em_theme_url(); ?>/pages/domain/images/benefit-2.webp" alt="" loading="lazy"></div>
        <div class="feature-content"><h3>Full setup &amp; transfer</h3><p>We move your entire store to your new domain and configure everything &ndash; no technical work for you.</p></div>
      </div>
...
<section class="lp-cta">
  <div class="container">
    <div class="lp-cta-box reveal">
      ...
      <h2 class="section-title">Get your store and domain <em>today</em></h2>
      <p class="section-sub">Start with a free store and a quality domain that sets you up for success.</p>
      <a href="<?php echo em_start_for_free_url(); ?>" class="btn-primary liquid-btn">Start Your Free Store <svg width="18" height="18" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round"><path d="M4 9h10M10 5l4 4-4 4"/></svg></a>
