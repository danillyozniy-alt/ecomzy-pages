  ...
  <div class="container">
    <div class="benefits-grid">
      <div class="benefit-card reveal">
        ...
        <h3>Zero manual setup</h3>
        <p>Your ads launch automatically when you activate your store. No setup, no guessing &ndash; completely hands-free.</p>
      </div>
  ...
  <div class="container">
    ...
    <div class="features-track">
      <div class="feature-card reveal">
        <div class="feature-img"><img src="<?php em_theme_url(); ?>/pages/paid-ads/images/benefit-1.webp" alt="" loading="lazy"></div>
        <div class="feature-content">
          <h3>Audience auto-targeting</h3>
          <p>Pinpoints high-intent shoppers across platforms using real performance data &ndash; no ad expertise needed.</p>
        </div>
      </div>
      ...
      <div class="feature-card reveal rd2">
        <div class="feature-img"><img src="<?php em_theme_url(); ?>/pages/paid-ads/images/benefit-3.webp" alt="" loading="lazy"></div>
        <div class="feature-content">
          <h3>Full cross-platform reach</h3>
          <p>One system pushes your products to Amazon, Google, Facebook, TikTok, and Instagram simultaneously.</p>
        </div>
      </div>
    </div>
